...
//			console.log(ev);
	...
	this.move = function() {
		...
		if(_this.isDead){
			...
			//localstorage添加分数
//			var numm=0;
//	        if(!localStorage.numm){
//		      localStorage.setItem("numm",parseInt(numm));
//	        }
//	        mast=_this.score;
//	        localStorage.setItem("numm",mast);
////	        location=location;
//	        getScroe();
//		function getScroe(){
//		
//		var keys1=localStorage.key(0);
//		var val1=localStorage.getItem(keys1);
//		   console.log(val1);
//		   }
